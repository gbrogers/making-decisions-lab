...
//Code Here
// let lastItemRemoved = arr[length-1]; //works

// let lastItemRemoved = arr.pop(); //works
// console.log(lastItemRemoved);
let lastItemRemoved = arr.splice(5, 1); // give back as an array // works
console.log(lastItemRemoved);
...
/*Subscripting an array can fail. What happens if you subscript to the 7th element, but there are not 7 elements in the array?
Now, use an if statement to help make sure you have the correct amount of elements, and then reset your variable, 
'problem9' to the value of the 7th element in the array.*/
